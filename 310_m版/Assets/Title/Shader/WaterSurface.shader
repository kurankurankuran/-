Shader "Custom/WaterSurface"
{
	Properties
	{
		...
		_Spec("Specular", Color) = (0.5, 0.5, 0.5)
		_Smooth("Smoothness", Range(0, 1)) = 1
		_Alpha("Alpha", Range(0, 1)) = 0.5


		[Header(Texture)]
		[MaterialToggle] _IsTex("Original Texture", Float) = 0
		_Complex("Complex", int) = 5
